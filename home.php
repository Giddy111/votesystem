				    ...
				    <?php
				    	...
				    	if($vquery->num_rows > 0){
						    ...
						    <form method="POST" id="ballotForm" action="submit_ballot.php">
				        		...
				        		?>
				        		<div class="text-center">
					        		<button type="button" class="w3-btn w3-hover-blue btn-success btn-flat" id="preview"><i class="fa fa-file-text"></i> Preview</button> 
					        		<button type="submit" class="w3-btn w3-hover-blue btn-primary btn-flat" name="vote"><i class="fa fa-check-square-o"></i> Submit</button>
					        	</div>
				        	</form>
				        	<!-- End Voting Ballot -->
				    		<?php
